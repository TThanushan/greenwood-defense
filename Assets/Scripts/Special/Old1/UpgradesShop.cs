...
public class UpgradesShop : MonoBehaviour
{
    ...
    public AudioClip maxLevelUnlocked;
    ...
    {
        SFXManager.instance.Play(Constants.BUTTON_CLICK_SFX_NAME);
    }
    ...
    void CreateUpgradeEffect()
    {
        ...
        effect.transform.position = selectCursor.transform.Find("CenterPosition").transform.position;
    ...
    {
        return selectedCard == "" ? null : buttonsParentTransform.Find(selectedCard);
    }
    ...
    bool IsUnitOfAnyLevelUnlocked(string unitName)
    {
        ...
        {
            if (GetUnitNameWithoutNumbers(name) == GetUnitNameWithoutNumbers(unitName))
                return true;
        }
    ...
    bool IsUnitLevelMax()
    {
        return selectedCard == "" ? false : GetUpgradeUnit(GetUnitNameFromSelectCard()) is null;
    }
    ...
    void Upgrade(string upgradeUnitName, string unitName, float price)
    {
        if (saveManager.IsModeNormalChosen())
        {
            ...
            _ = saveManager.unlockedUnits.Remove(unitName);
        }
        else
        {
    ...
    public void UnlockUnit()
    {
        ...
        if (!IsUnitOfAnyLevelUnlocked(unitName))
        {
            ...
            SFXManager.instance.Play(unlockSound);
        ...
        else
        {
            ...
            SFXManager.instance.Play(upgradeSound);
        }
        ...
        if (IsUnitLevelMax())
        {
            ...
            SFXManager.instance.Play(maxLevelUnlocked);
    ...
    void SetUpgradeButtonImage(Transform upgradeCardButton, string unitName)
    {
        ...
        else
        {
            ...
            _ = InstantiateSpriteBodyFromPrefabWithImage(unitName, upgradeCardButton);
    ...
    {
        text.colorGradientPreset = CanUpgrade(unitName) ? priceOriginalColor : tooExpensivePriceColor;
    }
    ...
    public void RemoveChosenUnit(string unitName)
    {
        ...
        _ = saveManager.chosenUnits.Remove(unitName);
        UpdateChosenUnitList();
        SortChosenUnitByCost();
    }
