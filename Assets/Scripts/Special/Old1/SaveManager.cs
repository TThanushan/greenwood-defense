...
public class SaveManager : MonoBehaviour
{
    ...
    public class SaveData
    {
        ...
        public List<string> unlockedHeroUpgrades = new List<string>();
        public List<string> unlockedUnits = new List<string>();
        public List<string> unlockedFrogUnitsLevel = new List<string>();
        public List<string> chosenUnits = new List<string>();
        public string chosenMode;
        public int newEnemyCardDescriptionShownedIndex;
        public float money;
    ...
    public void SaveGame()
    {
        SaveData saveData = new SaveData
        {
            ...
            levels = this.levels,
            unlockedHeroUpgrades = this.unlockedHeroUpgrades,
            unlockedUnits = this.unlockedUnits,
            unlockedFrogUnitsLevel = this.unlockedFrogUnitsLevel,
            chosenUnits = this.chosenUnits,
            chosenMode = this.chosenMode,
            newEnemyCardDescriptionShownedIndex = this.newEnemyCardDescriptionShownedIndex,
            money = this.money
        };
    ...
    public void LoadGame()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            maxLevelUnlocked = saveData.maxLevelUnlocked;
            isAutoSave = saveData.isAutoSave;
            levels = saveData.levels;
            unlockedHeroUpgrades = saveData.unlockedHeroUpgrades;
            unlockedUnits = saveData.unlockedUnits;
            unlockedFrogUnitsLevel = saveData.unlockedFrogUnitsLevel;
            chosenUnits = saveData.chosenUnits;
            chosenMode = saveData.chosenMode;
            newEnemyCardDescriptionShownedIndex = saveData.newEnemyCardDescriptionShownedIndex;
    ...
    // Make a method that will allow to load a specific json save file into the game. The method will have a parameter that will be the name of the save file to load inside the Unity Resource folder.
    public void LoadMaxLevelUnlockedSave()
    {
        TextAsset saveFile = Resources.Load<TextAsset>("gameSaveMaxLevelUnlocked");
        SaveData saveData = JsonUtility.FromJson<SaveData>(saveFile.text);
        ...
        newEnemyCardDescriptionShownedIndex = saveData.newEnemyCardDescriptionShownedIndex;
        money = saveData.money;
        Debug.Log("gameSaveMaxLevelUnlocked loaded!");
    }
    ...
    public void ReplaceUnlockedFrogUnitLevel(string unitName)
    {
        ...
        _ = unlockedFrogUnitsLevel.Remove(nameToRemove);
    ...
    void InitsHeroUpgrades()
    {
        heroUpgrades = new List<HeroUpgrade>
        {
            ...
            new HeroUpgrade("UnitMaxHealthBonus12", "Increase units max health by 12%", 750),
            new HeroUpgrade("UnitMaxHealthBonus24", "Increase units max health (12% => 24%)", 1500),
            new HeroUpgrade("UnitMaxHealthBonus36", "Increase units max health (24% => 36%)", 2250),
            new HeroUpgrade("UnitMaxHealthBonus48", "Increase units max health (36% => 48%)", 3000),
            new HeroUpgrade("UnitMaxHealthBonus60", "Increase units max health (48% => 60%)", 3750),
            new HeroUpgrade("UnitMaxHealthBonus72", "Increase units max health (60% => 72%)", 4500),
            new HeroUpgrade("UnitMaxHealthBonus84", "Increase units max health (72% => 84%)", 5250),
            new HeroUpgrade("UnitMaxHealthBonus96", "Increase units max health (84% => 96%)", 6000),
            new HeroUpgrade("UnitMaxHealthBonus108", "Increase units max health (96% => 108%)", 6750),
            new HeroUpgrade("UnitMaxHealthBonus120", "Increase units max health (108% => 120%)", 7500),


            new HeroUpgrade("UnitDamageBonus0"),
            new HeroUpgrade("UnitDamageBonus6", "Increase units attack damage by 6%", 750),
            new HeroUpgrade("UnitDamageBonus12", "Increase units attack damage (6 => 12%)", 1500),
            new HeroUpgrade("UnitDamageBonus18", "Increase units attack damage (12 => 18%)", 2250),
            new HeroUpgrade("UnitDamageBonus24", "Increase units attack damage (18 => 24%)", 3000),
            new HeroUpgrade("UnitDamageBonus30", "Increase units attack damage (24 => 30%)", 3750),
            new HeroUpgrade("UnitDamageBonus36", "Increase units attack damage (30 => 36%)", 4500),
            new HeroUpgrade("UnitDamageBonus42", "Increase units attack damage (36 => 42%)", 5250),
            new HeroUpgrade("UnitDamageBonus48", "Increase units attack damage (42 => 48%)", 6000),
            new HeroUpgrade("UnitDamageBonus54", "Increase units attack damage (48 => 54%)", 6750),
            new HeroUpgrade("UnitDamageBonus60", "Increase units attack damage (54 => 60%)", 7500),

            new HeroUpgrade("UnitDamageReduction0"),
            new HeroUpgrade("UnitDamageReduction6", "Units damage received reduced by 6%", 750),
            new HeroUpgrade("UnitDamageReduction12", "Units damage received reduced (6 => 12%)", 1500),
            new HeroUpgrade("UnitDamageReduction18", "Units damage received reduced (12 => 18%)", 2250),
            new HeroUpgrade("UnitDamageReduction24", "Units damage received reduced (18 => 24%)", 3000),
            new HeroUpgrade("UnitDamageReduction30", "Units damage received reduced (24 => 30%)", 3750),
            new HeroUpgrade("UnitDamageReduction36", "Units damage received reduced (30 => 36%)", 4500),
            new HeroUpgrade("UnitDamageReduction42", "Units damage received reduced (36 => 42%)", 5250),
            new HeroUpgrade("UnitDamageReduction48", "Units damage received reduced (42 => 48%)", 6000),
            new HeroUpgrade("UnitDamageReduction54", "Units damage received reduced (48 => 54%)", 6750),
            new HeroUpgrade("UnitDamageReduction60", "Units damage received reduced (54 => 60%)", 7500),

            new HeroUpgrade("UnitCooldownReduction0"),
            new HeroUpgrade("UnitCooldownReduction6", "Reduce unit spawn cooldown by 6%",200),
            new HeroUpgrade("UnitCooldownReduction12", "Reduce unit spawn cooldown (6 => 12%)",400),
            new HeroUpgrade("UnitCooldownReduction18", "Reduce unit spawn cooldown (12 => 18%)",600),
            new HeroUpgrade("UnitCooldownReduction24", "Reduce unit spawn cooldown (18 => 24%)",800),
            new HeroUpgrade("UnitCooldownReduction30", "Reduce unit spawn cooldown (24 => 30%)",800),
            new HeroUpgrade("UnitCooldownReduction36", "Reduce unit spawn cooldown (30 => 36%)",1000),
            new HeroUpgrade("UnitCooldownReduction42", "Reduce unit spawn cooldown (36 => 42%)",1200),
            new HeroUpgrade("UnitCooldownReduction48", "Reduce unit spawn cooldown (42 => 48%)",1400),
            new HeroUpgrade("UnitCooldownReduction54", "Reduce unit spawn cooldown (48 => 54%)",1600),
            new HeroUpgrade("UnitCooldownReduction60", "Reduce unit spawn cooldown (54 => 60%)",1800),
    ...
    void InitUnits()
    {
        units = new List<Unit>
        {
            ...
            new Unit("Ghost2", 55, 15, 750, "Invulnerable for x seconds, every x seconds (scale with level)."),
    ...
    void InitFirstTimeUnlockedUnits()
    {
        ...
        unlockedUnits = IsModeNormalChosen()
            ? new List<string>
            {
                "Chicken1",
                "Duck1",
    ...
    {
        chosenUnits = IsModeNormalChosen()
            ? new List<string>()
            {
                "Chicken1",
                "Duck1",
    ...
    {
        return IsModeNormalChosen() ? Constants.UNITS_PREFAB_RESOURCES_PATH : Constants.UNITS_FROG_PREFAB_RESOURCES_PATH;
    }
...
public class SaveData
{
    ...
    public string SerializeSaveData()
    {
        SaveData saveData = new SaveData
        {
            ...
            unlockedUnits = this.unlockedUnits,
            unlockedFrogUnitsLevel = this.unlockedFrogUnitsLevel,
            // Populate the save data object with current game state
        };
