...
public class SaveManager : MonoBehaviour
{
    ...
    void InitUnits()
    {
        units = new List<Unit>
        {
            ...
            new Unit("Chicken2", 35, 8, 300, "Every 3 attacks, double hit"),
            new Unit("Chicken3", 45, 6, 450, "Every 3 attacks, triple hit and 50% chance to dodge an attack"),
            new Unit("Chicken4", 55, 6, 600, "When under 25% health, attack speed is increase by 500%, each hit increase attack damage by 5% until 50%)"),

            new Unit("Duck1", 30, 8, 150),
            new Unit("Duck2", 40, 10, 300, "Every 3 hit received, block next hit"),
            new Unit("Duck3", 50, 12, 450, "Start with a big shield that blocks the 5 next hit, when big shield is down, receive defense bonus for x seconds, big shield reappears after x seconds."),
            new Unit("Duck4", 60, 14, 600, "Big shield now blocks 10 next hit instead of 5, when big shield is down, receive defense bonus for x seconds, big shield reappears after x seconds. When any shield is up, restore x% max health over time."),

            new Unit("Trunk1", 30, 10, 150),
            new Unit("Trunk2", 45, 12, 300, "Shoot 3 times in row (on every attack)."),
            new Unit("Trunk3", 60, 14, 450, "Increased shooting speed."),
            new Unit("Trunk4", 75, 16, 600, "Gatling shooting."),
            ...
            new Unit("Rock4", 35, 12, 650, "Become invulnerable for an amount of time."),
            ...
            new Unit("Bunny4", 35, 10, 650, "Instead of an army of weak rabbits, summon an army of unique rabbits (dps or tank)."),
            ...
            new Unit("Plant4", 90, 18, 700, "Shoot an explosive bullet."),
            ...
            new Unit("Mushroom4", 75, 16, 1500, "After being poisoned for a certain amount of time, enemy are paralysed for a short amount of time."),
            ...
            new Unit("BlueBird4", 75, 16, 1500, "Summon a bird that will drop multiple eggs that spawn small birds on enemies."),
            ...
            new Unit("Snail4", 75, 16, 1500, "When an close ally is low life, start a strong global healing.")
        };
