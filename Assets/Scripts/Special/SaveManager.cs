...
public class SaveManager : MonoBehaviour
{
    ...
    void InitsHeroUpgrades()
    {
        heroUpgrades = new List<HeroUpgrade>
        {
            ...
            new HeroUpgrade("AbilityRandomSpawn1", "Spawn for free 1 random unit", 400, 0, 25),
            new HeroUpgrade("AbilityRandomSpawn2", "Spawn for free 2 random unit", 900, 0, 60),
            new HeroUpgrade("AbilityRandomSpawn3", "Spawn for free 3 random unit", 1500, 0, 100),
            new HeroUpgrade("AbilityRandomSpawn4", "Spawn for free 4 random unit", 2200, 0, 150),
            new HeroUpgrade("AbilityDamageBuff0", "Increase units damage for x seconds"),
            new HeroUpgrade("AbilityDamageBuff1", "Increase units damage for x seconds", 500, 0, 30),
            new HeroUpgrade("AbilityDamageBuff2", "Increase units damage for x seconds", 1000, 0, 60),
            new HeroUpgrade("AbilityDamageBuff3", "Increase units damage for x seconds", 1500, 0, 90),
            new HeroUpgrade("AbilityDamageBuff4", "Increase units damage for x seconds", 2000, 0, 120),
            new HeroUpgrade("AbilityParalysis0", "Paralyse enemies for x seconds"),
            new HeroUpgrade("AbilityParalysis1", "Paralyse enemies for x seconds", 600, 0, 70),
            new HeroUpgrade("AbilityParalysis2", "Paralyse enemies for x seconds", 1200, 0, 105),
            new HeroUpgrade("AbilityParalysis3", "Paralyse enemies for x seconds", 1800, 0, 140),
            new HeroUpgrade("AbilityParalysis4", "Paralyse enemies for x seconds", 2000, 0, 175),
            new HeroUpgrade("AbilityLightning0", "Makes the lightning fall all enemies and makes them take x amount of damage"),
            new HeroUpgrade("AbilityLightning1", "Makes the lightning fall all enemies and makes them take x amount of damage", 500, 0, 30),
            new HeroUpgrade("AbilityLightning2", "Makes the lightning fall all enemies and makes them take x amount of damage", 1000, 0, 60),
            new HeroUpgrade("AbilityLightning3", "Makes the lightning fall all enemies and makes them take x amount of damage", 1500, 0, 90),
            new HeroUpgrade("AbilityLightning4", "Makes the lightning fall all enemies and makes them take x amount of damage", 2000, 0, 120),
    ...
    void InitUnits()
    {
        units = new List<Unit>
        {
            ...
            new Unit("FireSkull1", 65, 13, 990f, "Shoot fireball that explode (small radius)."),
