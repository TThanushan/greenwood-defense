...
public class SaveManager : MonoBehaviour
{
    ...
    void InitsHeroUpgrades()
    {
        heroUpgrades = new List<HeroUpgrade>
        {
            ...
            new HeroUpgrade("AbilityDamageBuff1", "Increase units damage by 2.5 for 5 seconds", 500, 0, 30),
            new HeroUpgrade("AbilityDamageBuff2", "Increase units damage by 5 for 5 seconds", 1000, 0, 60),
            new HeroUpgrade("AbilityDamageBuff3", "Increase units damage by 7.5 for 5 seconds", 1500, 0, 90),
            new HeroUpgrade("AbilityDamageBuff4", "Increase units damage by 9 for 5 seconds", 2000, 0, 120),
            new HeroUpgrade("AbilityParalysis0", "Paralyse enemies for x seconds"),
            new HeroUpgrade("AbilityParalysis1", "Paralyse enemies for 1.5 seconds", 600, 0, 70),
            new HeroUpgrade("AbilityParalysis2", "Paralyse enemies for 3 seconds", 1200, 0, 105),
            new HeroUpgrade("AbilityParalysis3", "Paralyse enemies for 4.5 seconds", 1800, 0, 140),
            new HeroUpgrade("AbilityParalysis4", "Paralyse enemies for 6 seconds", 2000, 0, 175),
            new HeroUpgrade("AbilityLightning0", "Makes the lightning fall all enemies and makes them take x amount of damage"),
            new HeroUpgrade("AbilityLightning1", "Makes the lightning fall all enemies and makes them take 10 amount of damage", 500, 0, 30),
            new HeroUpgrade("AbilityLightning2", "Makes the lightning fall all enemies and makes them take 20 amount of damage", 1000, 0, 60),
            new HeroUpgrade("AbilityLightning3", "Makes the lightning fall all enemies and makes them take 30 amount of damage", 1500, 0, 90),
            new HeroUpgrade("AbilityLightning4", "Makes the lightning fall all enemies and makes them take 40 amount of damage", 2000, 0, 120),
